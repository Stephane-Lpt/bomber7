...
public class LevelMapTest {
    ...
    void testGetSquare_validCoordinates_returnsCorrectSquare() {
        ...
        Square square1 = new Square("assets/texture1.png", 101, new UnbreakableWall("assets/unbreakable.png", 1));
        Square square2 = new Square("assets/texture2.png", 102, new BreakableWall("assets/breakable.png", 2));
    ...
    void testGetSquare_invalidCoordinates_throwsException() {
        ...
        Square square = new Square("assets/texture.png", 1, new BreakableWall("assets/break.png", 2));
        List<List<Square>> checkerboard = new ArrayList<>();
